...
public class Selector : Expr
{
    ...
    private static string[] theSources = ["parent","hand","board","otherDeck","deck","otherHand","field","otherField"];
    ...
    public override object Evaluate(Scope scope)
    {
        ...
        Predicate<CardData> predicate = (Predicate<CardData>)Predicate!.Evaluate(scope);
